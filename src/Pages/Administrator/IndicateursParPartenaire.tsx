...
export const IndicateursParPartenaire = () => {
  const columnsActions: any[] = [
    {
      title: 'Titre',
      dataIndex: 'titre',
      key: 'titre'
  ...
  const dataActions = [
    {
      key: '1',
      titre: '1. Logement – Location',
      status: 1
    },
    {
      key: '2',
      titre: '2. Logement – Location',
      status: 2
    },
    {
      key: '3',
      titre: '3. Logement – Location',
      status: 3
    }
  ];
  const columns: any[] = [
